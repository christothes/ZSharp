...
namespace ZSharp.Nodes
{
    ...
    /// </summary>
    public class SwitchBinary : ZWaveNode, Switch
    {
        /// <summary>
        ...
        internal SwitchBinary(ZWavePort port, byte nodeId) : base(port, nodeId) 
        {
        ...
        protected void SetLevel(byte level)
        {
            ...
            job.Request = new ZWaveMessage(ZWaveProtocol.MessageType.REQUEST,
                                           ...
                                           this._nodeId,
                                           ZWaveProtocol.CommandClass.SWITCH_BINARY,
                                           ZWaveProtocol.Command.SWITCH_BINARY_SET);
        ...
        public void On()
        {
            this.SetLevel(ZWaveProtocol.ValueConstants.ON);
        }
        ...
        public void Off()
        {
            this.SetLevel(ZWaveProtocol.ValueConstants.OFF);
        }
                ...
                case ZWaveProtocol.Function.SEND_DATA:
                    switch (response.Function)
                    {
                        case ZWaveProtocol.Function.APPLICATION_COMMAND_HANDLER:
                            switch (response.CommandClass)
                            {
                                case ZWaveProtocol.CommandClass.SWITCH_BINARY:
                                    ...
                                    {
                                        case ZWaveProtocol.Command.SWITCH_BINARY_REPORT:
                        ...
                        case ZWaveProtocol.Function.SEND_DATA:
                            ...
                            {
                                case ZWaveProtocol.Command.SWITCH_BINARY_SET:
